// Disables validation if the register button is clicked.
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener("submit", function(e) {
        // Email validation.
        let email = document.querySelector('input[name="userid"]');
        ...
        if (!(password.value).match(/^[0-9]?[a-zA-Z]+[0-9]?(-[0-9]?[a-zA-Z]+[0-9]?)+/) && allowValidation) {
            e.preventDefault();
